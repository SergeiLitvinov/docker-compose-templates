...
##! https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instancedata-data-retrieval.html
 external_url 'https://{{ gitlab address }}'
...
gitlab_rails['gitlab_ssh_host'] = '{{ gitlab ssh host as main address }}'
...
gitlab_rails['gitlab_email_from'] = '{{ mail user login }}'
# gitlab_rails['gitlab_email_display_name'] = 'Example'
gitlab_rails['gitlab_email_reply_to'] = '{{ mail noreply login }}'
...
# gitlab_rails['gitlab_issue_closing_pattern'] = "\b((?:[Cc]los(?:e[sd]?|ing)|\b[Ff]ix(?:e[sd]|ing)?|\b[Rr]esolv(?:e[sd]?|ing)|\b[Ii]mplement(?:s|ed|ing)?)(:?) +(?:(?:issues? +)?%{issue_ref}(?:(?:, *| +and +)>
...
gitlab_rails['smtp_address'] = "{{ smtp address }}"
gitlab_rails['smtp_port'] = 25
gitlab_rails['smtp_user_name'] = "{{ mail user }}"
gitlab_rails['smtp_password'] = "{{ user mail pass }}"
...
registry_external_url 'https://{{ registry host }}'
...
# gitlab_rails['registry_api_url'] = "http://localhost:5000"
 gitlab_rails['registry_api_url'] = "https://{{ registry host }}"
...
# pages_nginx['ssl_certificate'] = "/etc/gitlab/ssl/pages.xn--80apqkhcno.xn--p1ai.crt"
# pages_nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/pages.xn--80apqkhcno.xn--p1ai.key"
